...
test_starting_position1 = np.random.uniform(20, max_angle)
test_starting_position2 = np.random.uniform(20, max_angle)
...
#    print("current jitter %s" %jitter)
    ...
    for invar_density in [5]: #np.arange(10, 30, 10):
            try:
                kernel = get_Polynomial_2D_Local_Invariance(2, 40, jitter, [3,3,3,3]) #switch
