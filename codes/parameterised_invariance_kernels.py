...
#        self.f1_poly = gpflow.Parameter(tf.Variable([0,0,0,0.1,0], dtype=tf.float64)[:,None], transform=tfp.bijectors.Sigmoid(to_default_float(-1.), to_default_float(1.)), trainable=False)
#        self.f2_poly = gpflow.Parameter(tf.Variable([0,0,0,0,0.1], dtype=tf.float64)[:,None], transform=tfp.bijectors.Sigmoid(to_default_float(-1.), to_default_float(1.)), trainable=False)
#        self.g1_poly = gpflow.Parameter(tf.Variable([0,0.1,0,0,0], dtype=tf.float64)[:,None], transform=tfp.bijectors.Sigmoid(to_default_float(-1.), to_default_float(1.)), trainable=False)
#        self.g2_poly = gpflow.Parameter(tf.Variable([0,0,0.1,0,0], dtype=tf.float64)[:,None], transform=tfp.bijectors.Sigmoid(to_default_float(-1.), to_default_float(1.)), trainable=False)
        self.jitter = jitter_size
