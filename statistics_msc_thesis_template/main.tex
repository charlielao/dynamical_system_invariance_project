...
Here, instead of modelling everything as forces, we combine both observed dyanmics as well as latent dynamics and relate them using the invariance relation. 
