...
Here, since the white noise is uncorrelated with each other, the only place the noise will enter is $D$, so we simply have to add a noise term to $D$ and replace all $D$ with $\tilde{D}=D+\epsilon \mathbb{I}$, where $\epsilon$ is a parameter to be learnt. 
...
Method           & RBF & Known Invariance&  Learnt Invariance\\
  \hline
Log Marginal Likelihood & 429.50 & 474.23 & 471.04  \\
MSE & 0.0207 & 0.0036 & 0.0035 \\
                    \hline
  \end{tabular}
...
We also found a Pearson correlation between log marginal likelihood and MSE of $-0.6502$ with a p value of $3.218\times 10^{-7}$, therefore, it is clear we are learning the correct invariance. 
...
Method           & RBF & Known Invariance&  Learnt Invariance\\
  \hline
Log Marginal Likelihood & 794.27 & 846.72 & 848.54  \\
MSE & 0.0064 & 0.0019 & 0.0029 \\
    \hline
  \end{tabular}
